...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-white border-b border-border shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16", children: [
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "bg-secondary py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-navy mb-4 bg-white px-3 py-1 rounded-full border border-border", children: "Chittorgarh's #1 Digital Agency" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-[3.4rem] font-extrabold text-charcoal leading-tight mb-6", children: [
        "We Help Chittorgarh's Top Businesses",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-navy", children: "Dominate the Local Market." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground mb-8 leading-relaxed", children: "High-Impact Reels and Google Maps SEO that brings customers directly to your doorstep." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-3xl bg-navy opacity-10 blur-2xl scale-110" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl shadow-card border border-border p-8 w-full max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-navy rounded-xl p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-6 w-6 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: "Standard Plan Results" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-charcoal", children: "Monthly Average" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatRow,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-5 w-5 text-navy" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatRow,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-5 w-5 text-navy" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatRow,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-5 w-5 text-navy" }),
              label: "Google Maps Rank",
              value: "#1"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 pt-5 border-t border-border text-xs text-muted-foreground text-center", children: "Results from active clients in Chittorgarh" })
      ] })
    ] }) })
  ] }) }) });
}
function StatRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-charcoal text-lg", children: value })
  ] });
}
function RoiSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-charcoal mb-3", children: "The Growth Projection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "See the real difference Zenvora Media makes for local businesses." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-stretch max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-secondary rounded-2xl md:rounded-r-none md:rounded-l-2xl p-8 border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4", children: "Before Zenvora" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-charcoal mb-6", children: "Average Shop Today" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 h-5 w-5 rounded-full border-2 border-muted-foreground/30 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: item })
        ] }, item)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-4 md:py-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex flex-col items-center justify-center bg-navy h-full px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-8 w-8 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-navy rounded-full p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-6 w-6 text-white rotate-90" }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-navy rounded-2xl md:rounded-l-none md:rounded-r-2xl p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-white/60 mb-4", children: "After Zenvora" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-6", children: "Standard Plan Results" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "mt-0.5 h-5 w-5 text-whatsapp flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white/90", children: item })
        ] }, item)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center mt-10 text-lg font-bold text-charcoal", children: "Visible Growth. Real Results. Local Impact." })
  ] }) });
}
const plans = [
  {
...
function PricingSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "pricing", className: "bg-secondary py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-charcoal mb-3", children: "Choose Your Growth Plan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-lg mx-auto", children: "First-month promotional pricing available. Lock in your rate today." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PricingCard, { plan, index: i + 1 }, plan.name)) })
  ] }) });
}
function PricingCard({ plan, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `relative flex flex-col rounded-xl overflow-hidden border shadow-card ${plan.popular ? "border-navy" : "border-border"} bg-white`,
      "data-ocid": `pricing.item.${index2}`,
      children: [
        plan.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-navy text-white text-xs font-bold uppercase tracking-widest text-center py-2 px-4", children: plan.badge }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-charcoal mb-3", children: plan.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
            plan.priceOriginal && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm line-through text-muted-foreground mr-2", children: plan.priceOriginal }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-extrabold text-navy", children: plan.pricePromo }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground ml-1", children: plan.period }),
            plan.priceOriginal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-whatsapp font-semibold mt-1", children: "Promo: First month only" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2", children: "Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: plan.services.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                className: "flex items-start gap-2 text-sm text-foreground",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-navy mt-0.5 flex-shrink-0" }),
                  s
                ]
              },
              s
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2", children: "Expected Results" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: plan.results.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                className: "flex items-start gap-2 text-sm text-muted-foreground",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-4 w-4 text-amber-400 mt-0.5 flex-shrink-0" }),
                  r
                ]
              },
              r
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noopener noreferrer",
              className: `w-full text-center font-bold text-sm py-3 rounded-lg transition-colors ${plan.popular ? "bg-navy text-white hover:bg-navy-dark" : "border border-navy text-navy hover:bg-navy hover:text-white"}`,
              "data-ocid": `pricing.primary_button.${index2}`,
              children: plan.cta
            }
          )
        ] })
...
function WhyUsSection() {
  const features = [
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-7 w-7 text-navy" }),
      title: "Local Market Experts",
      desc: "We live and work in Chittorgarh. We know your customers, your lanes, and your competition."
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "h-7 w-7 text-navy" }),
      title: "On-Location Shoots",
      desc: "We come to your shop. Real visuals, real stories. No generic stock footage."
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-7 w-7 text-navy" }),
      title: "Proven ROI",
      desc: "Every rupee you spend is tracked. You see the views, the calls, the walk-ins."
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-7 w-7 text-navy" }),
      title: "Full-Service Growth",
      desc: "From content to SEO to ads — one team handles everything."
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "why-us", className: "bg-white py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-charcoal mb-3", children: "Why Zenvora Media?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-lg mx-auto", children: "We are not an outside agency. We are your local growth partner." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-start",
        "data-ocid": `whyus.item.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-secondary rounded-xl p-3 mb-4", children: f.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-charcoal mb-2", children: f.title }),
...
function FinalCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "bg-navy py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-white mb-4 leading-tight", children: [
      "Ready to Grow Your Business? ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden sm:block" }),
      " ",
      "Message Us Now."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 mb-8 text-base", children: "Join Chittorgarh's growing businesses already winning online." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: WA_LINK,
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-charcoal py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white/60 text-sm", children: [
        "© ",
        year,
        " Zenvora Media. All rights reserved."
      ] })
    ] }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-inter", children: [
